...
englishManifest :: [(LexCat, [(LexCat, MorphType, [(Text, AllExpress)])], [(LexCat, MorphType, [(Text, AllExpress)])], [(LexCat, MorphType, [(Text, AllExpress)])])]
englishManifest = [eVerbInfl, eNounInfl, ePronInfl]

eVerbInfl :: (LexCat, [(LexCat, MorphType, [(Text, AllExpress)])], [(LexCat, MorphType, [(Text, AllExpress)])], [(LexCat, MorphType, [(Text, AllExpress)])])
...
ePronParticle1 :: (LexCat, MorphType, [(Text, AllExpress)])
